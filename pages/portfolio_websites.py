...
st.set_page_config(page_title="Portfolio Websites - Nexus Digital", page_icon=favicon, layout="wide")

# Load CSS and Sidebar fix
load_cyber_css()
...
# Header
st.markdown('<div class="hero-headline">PORTFOLIO WEBSITES</div>', unsafe_allow_html=True)
st.markdown('<div class="hero-subhead">Custom-built, SEO-friendly, and interactive. Stand out online.</div>', unsafe_allow_html=True)
...
with col1:
    ...
    st.markdown("### Veekshitha Samala - Data Analyst Portfolio")
    
    import os
    BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
    ASSETS_DIR = os.path.join(BASE_DIR, "assets")
    
    img_1 = os.path.join(ASSETS_DIR, "veekshitha_1.png")
    img_2 = os.path.join(ASSETS_DIR, "veekshitha_2.png")
    img_3 = os.path.join(ASSETS_DIR, "veekshitha_3.png")
    ...
    img_data = [
        {"path": img_1, "caption": "Hero Section"},
        {"path": img_2, "caption": "Technical Arsenal"},
        {"path": img_3, "caption": "Experience & Education"}
    ]
...
{track_html}
        ...
        st.warning("Portfolio images not found in the 'assets' folder.")
...
with col2:
    ...
    <div class="service-card" style="text-align: center;">
        <h2 style="color: var(--neon-green) !important; font-size: 3rem; margin: 10px 0;">₹1000</h2>
        <p style="color: var(--text-muted);">Flat rate for a standard multi-page portfolio.</p>
        <hr>
