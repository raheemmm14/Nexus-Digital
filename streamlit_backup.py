...
st.markdown("""
<div style="text-align: center; margin-bottom: 2rem; background-color: var(--card-bg); padding: 15px; border: 1px solid var(--neon-blue); border-radius: 5px; box-shadow: 0 0 10px rgba(0, 243, 255, 0.1);">
